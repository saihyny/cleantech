    ...
    <div className="hero-section  border-solid border-2 items-center xl:min-h-[450px] md:min-h-[650px] ">
      <h2 className="font-serif font-extrabold  p-10  text-red-400 shadow-2xl backdrop-filter backdrop-blur-sm bg-opacity-10 rounded-lg ">
        ...
        <span className="text-lg font-extralight  text-white font-serif rounded-md ">
          ...
          conditions by following the latest guidelines of{" "}
          <span className="font-bold">NABH</span>. Our engineers have strong
          command right from designing, manufacturing, installation to
          commissioning. Our young and energetic org. has a successful track
          record in completing many projects for various Hospitals within a
          short span since its inception. We have a team of multi disciplinary
          technocrats, each with exhaustive exposure to a wide spectrum of
        ...
        <div className=" border-2 border-solid rounded-lg m-1 bg-slate-300 h-auto w-auto  shadow-2xl ">
          <h1 class="text-3xl font-extrabold sm:text-5xl text-slate-600 ">
            ...
            <strong class="font-bold text-xl text-red-700 sm:block">
              {" "}
              Our mission is to deliver best-in-class products and services to
              our customers through association with super standard quality and
              in-depth knowledge of customer needs so as to ensure complete
